...
var MusicalScale = function () {
  ...
  _createClass(MusicalScale, [{
    key: 'pubUpdateScale',
    value: function pubUpdateScale(params) {
      var errors = this._errors(params);
      if (errors) return;
      this._loadScale(params);
    }
    ...
    key: '_loadScale',
    value: function _loadScale(params) {
    ...
    key: '_loadDictionary',
    value: function _loadDictionary() {
      return {
    ...
    key: '_paramMode',
    value: function _paramMode(mode) {
      return {
        minor: 'aeo',
        major: 'ion',
        ionian: 'ion',
    ...
    key: '_paramKey',
    value: function _paramKey(key) {
      if (this.dict.flat_sharp[key]) return this.dict.flat_sharp[key];
      return key;
    }
  }, {
    key: '_genTriads',
    value: function _genTriads(offset) {
    ...
    key: '_genSteps',
    value: function _genSteps(steps_str) {
...
var ArpeggioPatterns = function () {
  ...
  _createClass(ArpeggioPatterns, [{
    key: 'pubUpdatePatterns',
    value: function pubUpdatePatterns(params) {
      this.steps = params.steps;
      this._loadPatterns();
    }
  }, {
    ...
    key: '_permute',
    value: function _permute(input, permutations) {
...
var ArpPlayer = function () {
  ...
  _createClass(ArpPlayer, [{
    key: '_loadSynths',
    value: function _loadSynths() {
      this.channel = {
    ...
    key: '_loadBPMSelector',
    value: function _loadBPMSelector() {
      var _this5 = this;
    ...
    key: '_loadChordSelector',
    value: function _loadChordSelector() {
      var _this6 = this;
    ...
    key: '_loadKeySelector',
    value: function _loadKeySelector() {
      var _this7 = this;
    ...
    key: '_loadModeSelector',
    value: function _loadModeSelector() {
      var _this8 = this;
    ...
    key: '_loadTypeSelector',
    value: function _loadTypeSelector() {
      var _this9 = this;
    ...
    key: '_loadStepsSelector',
    value: function _loadStepsSelector() {
      var _this10 = this;
    ...
    key: '_loadPatternSelector',
    value: function _loadPatternSelector() {
    ...
    key: '_updatePatternSelector',
    value: function _updatePatternSelector() {
      var _this11 = this;
    ...
    key: '_genPatternSvg',
    value: function _genPatternSvg(pattern) {
    ...
    key: '_setMusicalScale',
    value: function _setMusicalScale() {
      var _this12 = this;
    ...
    key: '_setArpeggioPatterns',
    value: function _setArpeggioPatterns() {
      var _this13 = this;
    ...
    key: '_utilClassToggle',
    value: function _utilClassToggle(el, classname) {
